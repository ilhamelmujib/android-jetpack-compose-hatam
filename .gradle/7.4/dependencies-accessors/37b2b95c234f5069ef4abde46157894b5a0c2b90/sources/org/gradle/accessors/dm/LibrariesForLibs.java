...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     */
    public GooglemapsLibraryAccessors getGooglemaps() { return laccForGooglemapsLibraryAccessors; }
     ...
     */
    public RometoolsLibraryAccessors getRometools() { return laccForRometoolsLibraryAccessors; }

    /**
     * Returns the group of libraries at secrets
     */
    public SecretsLibraryAccessors getSecrets() { return laccForSecretsLibraryAccessors; }
    ...
    public static class AndroidxBenchmarkMacrobenchmarkLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public AndroidxBenchmarkMacrobenchmarkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("androidx.benchmark.macrobenchmark"); }
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getMaterialWindow() { return create("androidx.compose.materialWindow"); }
    ...
    public static class AndroidxTestExtLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxTestExtLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getTruth() { return create("androidx.test.ext.truth"); }
    ...
    public static class CoreLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public CoreJdkLibraryAccessors getJdk() { return laccForCoreJdkLibraryAccessors; }
    ...
    public static class CoreJdkLibraryAccessors extends SubDependencyFactory {
        ...
        public CoreJdkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getDesugaring() { return create("core.jdk.desugaring"); }
    ...
    public static class GooglemapsLibraryAccessors extends SubDependencyFactory {
        ...
        public GooglemapsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompose() { return create("googlemaps.compose"); }

            /**
             * Creates a dependency provider for maps (com.google.android.gms:play-services-maps)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getMaps() { return create("googlemaps.maps"); }
    ...
    public static class RometoolsLibraryAccessors extends SubDependencyFactory {
        ...
        public RometoolsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getModules() { return create("rometools.modules"); }

            /**
             * Creates a dependency provider for rome (com.rometools:rome)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getRome() { return create("rometools.rome"); }
    ...
    public static class SecretsLibraryAccessors extends SubDependencyFactory {
        ...
        public SecretsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for gradlePlugin (com.google.android.libraries.mapsplatform.secrets-gradle-plugin:secrets-gradle-plugin)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getGradlePlugin() { return create("secrets.gradlePlugin"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: jdkDesugar (1.1.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: material (1.8.0-alpha02)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class AndroidxComposeVersionAccessors extends VersionFactory  {
        ...
        public AndroidxComposeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidx.compose.bom (2022.11.00)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
